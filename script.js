...
// Update community stats with correct values
function updateCommunityStats() {
    // Update the stats to match the new design
    const statsData = [
        { selector: '.community-stat-card:nth-child(1) .stat-number', value: '15,000+' },
        { selector: '.community-stat-card:nth-child(2) .stat-number', value: '500K+' },
        { selector: '.community-stat-card:nth-child(3) .stat-number', value: '$2.5M+' }
    ];
...
// Animate stats counters when they come into view (for legacy support)
